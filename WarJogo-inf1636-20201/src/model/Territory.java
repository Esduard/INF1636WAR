	    ...
	    ArrayList<String> perth_n = new ArrayList<String>(
		  ...
		  //public Territory(String n, ArrayList<String> neighbors );
		    ...
		    territories.add(new Territory("Alasca"			, alasca_n, new ArrayList<Point>(Arrays.asList(
                    new Point(86.1, 124.1),
                    new Point(134.6, 124.1),
                    new Point(111.4, 167.3),
                    new Point(58.7, 167.3),
                    new Point(72.3, 141.8),
                    new Point(77.3, 141.8)))));
		    territories.add(new Territory("Calgary"			, calgary_n, new ArrayList<Point>(Arrays.asList(
                    new Point(148.7, 124.1),
                    new Point(134.6, 124.1),
                    new Point(126.4, 139.5),
                    new Point(146.9, 177.0),
                    new Point(223.0, 177.0),
                    new Point(231.3, 163.2),
                    new Point(245.5, 163.2),
                    new Point(258.5, 139.5),
                    new Point(284.1, 139.5),
                    new Point(271.6, 116.9),
                    new Point(241.7, 116.9),
                    new Point(230.4, 137.8),
                    new Point(212.9, 137.8),
                    new Point(208.7, 130.1),
                    new Point(152.4, 130.1)))));
		    territories.add(new Territory("California"		, california_n, new ArrayList<Point>(Arrays.asList(
                    new Point(107.5, 220.0),
                    new Point(84.7, 258.0),
                    new Point(89.9, 268.9),
                    new Point(78.2, 289.0),
                    new Point(90.4, 310.2),
                    new Point(126.4, 310.2),
                    new Point(178.5, 220.0)))));
		    territories.add(new Territory("Groenlandia"		, groenlandia_n, new ArrayList<Point>(Arrays.asList(
                    new Point(285.4, 94.6),
                    new Point(271.6, 116.9),
                    new Point(284.1, 139.5),
                    new Point(328.7, 139.5),
                    new Point(335.1, 149.5),
                    new Point(350.8, 149.5),
                    new Point(365.9, 122.1),
                    new Point(371.4, 122.1),
                    new Point(380.4, 108.5),
                    new Point(371.0, 94.6)))));
		    territories.add(new Territory("Mexico"			, mexico_n,new ArrayList<Point>(Arrays.asList(
                    new Point(90.4, 310.2),
                    new Point(83.1, 323.0),
                    new Point(103.6, 359.2),
                    new Point(110.6, 346.5),
                    new Point(102.5, 330.6),
                    new Point(105.7, 324.8),
                    new Point(136.6, 377.6),
                    new Point(145.7, 377.6),
                    new Point(162.1, 408.2),
                    new Point(172.2, 408.2),
                    new Point(179.8, 421.9),
                    new Point(188.8, 406.2),
                    new Point(183.8, 398.0),
                    new Point(178.5, 398.0),
                    new Point(173.0, 389.4),
                    new Point(173.0, 386.3),
                    new Point(175.3, 384.3),
                    new Point(167.1, 370.0),
                    new Point(171.8, 360.7),
                    new Point(164.3, 348.1),
                    new Point(161.4, 355.3),
                    new Point(152.3, 355.3),
                    new Point(126.4, 310.2)))));
		    territories.add(new Territory("Nova York"		, nova_york_n, new ArrayList<Point>(Arrays.asList(
                    new Point(181.8, 310.2),
                    new Point(165.7, 310.2),
                    new Point(202.2, 248.2),
                    new Point(231.7, 248.2),
                    new Point(246.1, 220.0),
                    new Point(296.9, 220.0),
                    new Point(290.7, 231.7),
                    new Point(279.4, 231.7),
                    new Point(261.5, 265.1),
                    new Point(243.7, 265.1),
                    new Point(237.8, 279.1),
                    new Point(231.3, 279.1),
                    new Point(215.3, 306.5),
                    new Point(207.3, 306.5),
                    new Point(200.6, 318.9),
                    new Point(211.5, 337.8),
                    new Point(204.3, 349.4)))));
		    territories.add(new Territory("Quebec"			, quebec_n, new ArrayList<Point>(Arrays.asList(
                    new Point(262.2, 190.8),
                    new Point(231.7, 190.8),
                    new Point(214.0, 220.0),
                    new Point(296.9, 220.0),
                    new Point(304.3, 207.1),
                    new Point(316.1, 207.1),
                    new Point(312.5, 215.3),
                    new Point(325.1, 215.3),
                    new Point(329.9, 204.5),
                    new Point(322.8, 191.4),
                    new Point(331.6, 177.8),
                    new Point(337.1, 184.7),
                    new Point(344.7, 172.2),
                    new Point(340.5, 163.4),
                    new Point(321.2, 163.4),
                    new Point(318.8, 160.4),
                    new Point(288.7, 160.4),
                    new Point(281.9, 171.9),
                    new Point(272.9, 171.9)))));
		    territories.add(new Territory("Texas"			, texas_n, new ArrayList<Point>(Arrays.asList(
                    ...
                    new Point(178.5, 220.0),
                    new Point(126.4, 310.2),
                    new Point(145.9, 343.8)))));
		    territories.add(new Territory("Vancouver"		, vancouver_n, new ArrayList<Point>(Arrays.asList(
                    new Point(111.4, 167.3),
                    new Point(119.3, 182.3),
                    new Point(102.1, 211.9),
                    new Point(107.5, 220.0),
                    new Point(214.0, 220.0),
                    new Point(231.7, 191.2),
                    new Point(223.0, 177.0),
                    new Point(146.90, 177.0),
                    new Point(126.4, 139.5)))));
