...
public class model {
	...
	public static void start(){
	  ...
	  //public Territory(String n, Color c, ArrayList<String> neighbors );
	    ...
	    Territories[0] 	= new Territory("Alaska"		,null, alaska_n);
	    Territories[1] 	= new Territory("Mackenzie"		,null, mackenzie_n);
	    ...
	    Territories[6] 	= new Territory("Labrador"		,null, labrador_n);
	    Territories[7] 	= new Territory("Ottawa"		,null, ottawa_n);
	    ...
	    Territories[11] = new Territory("Chile"			,null, chile_n);
	    Territories[12] = new Territory("Colombia"		,null, colombia_n);
	    ...
	    Territories[14] = new Territory("Sudao"			,null, sudao_n);
	    Territories[15] = new Territory("Argelia"		,null, argelia_n);
	    Territories[16] = new Territory("Egito"			,null, egito_n);
	    Territories[17]	= new Territory("Madagascar"	,null, madagascar_n);
	    Territories[18] = new Territory("Congo"			,null, congo_n);
	    ...
	    Territories[19]	= new Territory("Islandia"		,null, islandia_n);
	    Territories[20] = new Territory("Franca"		,null, franca_n);
	    Territories[21] = new Territory("Inglaterra"	,null, inglaterra_n);
	    Territories[22]	= new Territory("Polonia"		,null, polonia_n);
	    Territories[23] = new Territory("Suecia"		,null, suecia_n);
	    Territories[24] = new Territory("Moscou"		,null, moscou_n);
	    Territories[25] = new Territory("Alemanha"		,null, alemanha_n);
	    ...
	    Territories[26] = new Territory("China"			,null, china_n);
	    Territories[27] = new Territory("India"			,null, india_n);
	    Territories[28] = new Territory("Japao"			,null, japao_n);
	    Territories[29] = new Territory("Dudinka"		,null, dudinka_n);
	    Territories[30] = new Territory("Aral"			,null, aral_n);
	    Territories[31] = new Territory("Mongolia"		,null, mongolia_n);
	    Territories[32] = new Territory("Oriente Medio"	,null, oriente_medio_n);
	    Territories[33] = new Territory("Omsk"			,null, omsk_n);
	    Territories[34] = new Territory("Siberia"		,null, siberia_n);
	    Territories[35] = new Territory("Tchita"		,null, tchita_n);
	    Territories[36] = new Territory("Vietna"		,null, vietna_n);
	    Territories[37] = new Territory("Vladivostok"	,null, vladivostok_n);
	    ...
	    Territories[38] = new Territory("Australia"		,null, australia_n);
	    Territories[39] = new Territory("Sumatra"		,null, sumatra_n);
	    Territories[40] = new Territory("Nova Guine"	,null, nova_guine_n);
	    Territories[41] = new Territory("Borneo"		,null, borneo_n);
